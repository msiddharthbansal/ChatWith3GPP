...
A RAG chatbot over 3GPP telecom standards, built for a Graduate Engineer
Trainee take-home: build a working RAG chatbot over 3GPP documentation,
optimized for near-zero hallucination.
...
- **Releases: Rel-18 and Rel-19 only.** Both are frozen, so no moving
  ...
  considered and cut — not an oversight, a time-budget call. Multi-release
